    ...
    def update_flows(self, flows):
        ...
        for flow in flows:
            ...
            if old_data != None:
                ...
                if flow['in_bytes'] <= old_in_bytes:
                    in_bytes_delta = flow['in_bytes']
                else:
            ...
            # print('\nOLD LINK: ', old_link)
            if old_link != None:
                old_running_flows = dict(old_link).get('running_flows', [])
                print('\nold_running:', old_running_flows)

                running_flows = list(set(list(old_running_flows) + [flow_id]))
