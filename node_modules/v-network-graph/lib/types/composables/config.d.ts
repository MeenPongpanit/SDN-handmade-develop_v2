import type { Node, Edge, Path } from '..';
import type { ViewConfig, NodeConfig, EdgeConfig, PathConfig, Configs,  UserConfigs } from '../common/configs';
export declare function provideConfigs(configs: UserConfigs): Configs<Node, Edge, Path>;
